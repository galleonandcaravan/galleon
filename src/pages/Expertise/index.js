...
const Expertise = ({ switcherImagesVisible }) => (
  <div className="expertise" id="page-expertise">
    <MainContent
      ...
      text="By partnering with two award-winning fintech <br class='desktop' />firms, we offer innovative products and <br class='desktop' />tailored strategic solutions that get your funds where <br class='desktop' />they need to be, seamlessly."
    />
    <ImagesSwitcher
